...
@Slf4j
@Component
public class CallbackTaskSubscriberImpl implements CallbackTaskSubscriber{
    ...
    public void performTask(ConsumerRecord<String, DeliveryRequest> message) {
        ...
        try {
            ...
            validators.validateCallbackRequest(task);
            callbackUrlProcessor.processEngagement(task);
